<x-app-layout>
    ...
    <div class="space-y-8">
            ...
            <div class="p-6">
                <form class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="group">
                        ...
                        <div class="relative">
                            <i
                                class="fas fa-calendar-alt absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-blue-600 transition-colors"></i>
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <i
                                class="fas fa-filter absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-blue-600 transition-colors"></i>
        ...
        @if ($weeklyPlans->isEmpty())
            <div class="card card-hover">
                <div class="empty-state py-16">
                    ...
                    <p class="text-gray-600 mb-6">Rencana mingguan akan dibuat saat Anda membuat jadwal untuk mata
                        kuliah Anda.</p>
                    <a href="{{ route('weekly-plans.create') }}" class="btn-primary">
                        <i class="fas fa-plus mr-2"></i>
                        Buat Rencana Baru
        ...
        @else
            <div id="task-container" class="mt-8 mb-8"></div>
            ...
            <div class="card card-hover overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="plans-body" class="bg-white divide-y divide-gray-200"></tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function fetchData() {
                fetch("{{ route('tasks.filter.weekly') }}?semester=" + semester.value + "&course=" + course.value +
                        "&status=" + status.value)
                    .then(res => res.json())
                    .then(data => {
                        ...
                        <tr class="hover:bg-gray-50 transition-all duration-200 group">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">${plan.target_text?.substring(0,40) ?? ''}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="/weekly-plans/${plan.id}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-all duration-200">
                                        <i class="fas fa-eye mr-1"></i>Lihat
                                    </a>
                                    <a href="/weekly-plans/${plan.id}/edit" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 rounded-lg transition-all duration-200">
            ...
            [semester, course, status].forEach(el => {
