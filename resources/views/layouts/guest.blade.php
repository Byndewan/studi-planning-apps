...
<head>
    ...
    <title>{{ config('app.name', 'Study Planning') }}</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4">
        ...
        <div class="mb-8 animate-fadeInUp">
            <div class="flex items-center justify-center space-x-4 group">
                <div
                    class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
        ...
        <!-- Footer info -->
        <div class=" text-center text-sm text-gray-500 animate-fadeInUp delay-200">
            <p>&copy; {{ date('Y') }} Study Planning Support By <a href="https://www.instagram.com/byndewan_/"
                    target="_blank"><strong>@Abyan</strong></a> .All rights reserved.</p>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            buttons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    ripple.classList.add('absolute', 'bg-white', 'bg-opacity-30', 'rounded-full',
                        'animate-ping');
