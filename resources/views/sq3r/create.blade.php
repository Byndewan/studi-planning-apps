                ...
                <form method="POST" action="{{ route('sq3r.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="module_title" type="text" name="module_title" :value="old('module_title')" required
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Quickly scan the material to get an overview before diving in.</p>
                    </div>
