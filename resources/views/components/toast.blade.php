...
<div x-data="{ show: true }"
     ...
     @class([
        'fixed top-4 right-4 z-50 p-4 rounded-lg shadow-lg border-l-4 max-w-sm',
    ...
    <div class="flex items-start">
        ...
        <button @click="show = false" class="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex h-8 w-8">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
